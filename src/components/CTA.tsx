      ...
      >
        <div className="bg-midnight-light/30 backdrop-blur-md rounded-2xl p-12 border border-gold/20 shadow-2xl shadow-gold/5 text-center">
          <h2 className="font-serif text-4xl md:text-5xl mb-6">
            Prêt à rejoindre <span className="text-gold">La Réserve</span> ?
          </h2>
          
          <p className="text-xl text-offwhite/80 max-w-3xl mx-auto mb-12">
            Soyez parmi les premiers à investir dans la première collection DigitGold : 
            5000 NFTs, chacun représentant 2 grammes d'or physique, stockés en Europe.
          </p>
