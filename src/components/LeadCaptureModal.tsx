      ...
      <div className="relative bg-midnight-light border border-gold/20 rounded-xl max-w-md w-full shadow-2xl">
        ...
        {isSubmitted ? (
          <div className="p-8 text-center">
            ...
            <h3 className="text-2xl font-serif text-gold mb-4">Merci pour votre inscription !</h3>
          ...
          <div className="p-8">
            <div className="text-center mb-8">
              <h3 className="text-2xl font-serif text-gold mb-4">
                Recevez votre accès à la Réserve DigitGold
              </h3>
            ...
            <form onSubmit={handleSubmit}>
              ...
              <p className="text-xs text-offwhite/60 mt-4 text-center">
                En vous inscrivant, vous acceptez de recevoir des emails de DigitGold. 
